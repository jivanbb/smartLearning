...
<head>
  ...
  <link rel="stylesheet" href="<?= BASE_ASSET; ?>sweet-alert/sweetalert2.css">
  ...
  <script src="<?= BASE_ASSET ?>jquery-ui/external/jquery/jquery.js"></script>
  <script src="<?= BASE_ASSET ?>admin-lte/plugins/iCheck/icheck.min.js"></script>
  <script src="<?= BASE_ASSET; ?>sweet-alert/sweetalert2.all.min.js"></script>
  ...
  <div class="wrapper" id="app">
    ...
    <header class="main-header">
      ...
      <a href="<?= site_url('/'); ?>" class="logo">
        <span class="logo-mini"><b><img src="<?= BASE_ASSET ?>img/view2.png" height="40px"></b></span>
        <h2 class="m-0 text-white"><i class="fa fa-book me-3"></i>Smart Padhai</h2>
    ...
    <aside class="main-sidebar">
      <section class="sidebar sidebar-admin">
        <ul class="sidebar-menu  sidebar-admin tree" data-widget="tree">
          <?php if (get_option('menu') == "system") {
                        echo  display_menu_admin(0, 1);
                    } else {
                        echo display_customized_menu_admin(0, 1);
                    }  ?>
        </ul>
      </section>
    </aside>
...
<div id="new_customer" class="modal fade new-july-design" role="dialog">
   <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body new-july-design">
            <?= form_open('', [
               'name' => 'form_sp_customer_detail_add',
               'class' => 'form-horizontal',
               'id' => 'form_sp_customer_detail_add',
            ...
            <div class="form-group group-name ">
               <label for="name" class="col-sm-4 control-label"> Pan No<i class="required">*</i>
               </label>
               <div class="col-sm-8">
                  <input type="text" class="form-control" name="pan_no" id="pan_no" placeholder="Pan No" value="<?= set_value('pan_no'); ?>">
                  <small class="info help-block">
                  </small>
               </div>
            </div>
            ...
            <div class="form-group group-email ">
               ...
               <div class="col-sm-8">
                  <input type="text" class="form-control" name="phone_no" id="phone_no" placeholder="Phone No" value="<?= set_value('phone_no'); ?>">
               </div>
            </div>
            <div class="form-group group-name ">
               <label for="name" class="col-sm-4 control-label"> Is Client<i class="required">*</i>
               </label>
               <div class="col-sm-8">
                  <select name="is_client" class="form-control">
         ...
         <div class="modal-footer pr-5p">
            <button class="btn  btn-primary customer_save  btn_action " id="btn_save" data-stype='stay'> <?= cclang('save'); ?>
