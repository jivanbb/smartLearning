...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="#"><b><?= cclang('register_a_new_membership'); ?></b> </a>
    </div>
    <div class="login-box-body">
      ...
      <div class="form-group has-feedback <?= form_error('phone') ? 'has-error' : ''; ?>">
        ...
        <input type="text" class="form-control" placeholder="Phone" name="phone" value="<?= set_value('phone'); ?>">
      ...
      <div class="row">
        ...
        <div class="col-xs-5">
          <button type="submit" class="btn btn-primary btn-block btn-flat"><?= cclang('register_a_new_membership'); ?></button>
        </div>
      </div>
      <?= form_close(); ?>

      <a href="<?= admin_site_url('/login'); ?>" class="text-center">Back to login</a>
