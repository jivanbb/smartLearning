                ...
                <div class="tab-pane <?= empty($this->input->get('tab')) ? 'active' : '' ?>" id="tab_general">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="col-sm-12">
                        <label><?= cclang('menu'); ?> <span class="required">*</span></label>
                        <div class="row">
                          <div class="col-md-6 ">
                            <select class="form-control" data-width="100%" name="menu">
                                <option  <?= $menu == "system" ? 'selected' : ''; ?> value="system">System</option>
                                <option <?= $menu == "client" ? 'selected' : ''; ?>  value="client">Client</option>
                            </select>
                          </div>
                        </div>
                      </div>
