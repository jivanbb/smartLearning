         ...
         <div class="box box-warning">
            <div class="box-body ">
               <div class="box box-widget widget-user-2">
                  <form name="form_sp_materials" id="form_sp_materials" action="<?= admin_base_url('sp_materials'); ?>">
                     <button type="button" class="btn btn-flat btn-success btn_add_new pull-right" data-toggle="modal" data-target="#new_topic"><i class="fa fa-plus-square-o"></i> <?= cclang('materials'); ?></button>
                     <div class="row">
                        <div class="col-md-10">
                           ...
                           <div class="col-sm-1 padd-left-2 ">
                              <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= admin_base_url('/sp_materials'); ?>" title="<?= cclang('reset_filter'); ?>">
   ...
   <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title">Create Study Materials</h4>
         </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="form-group group-materials ">
                     <label for="materials" class="col-sm-3 control-label">Materials <i class="required">*</i>
                     </label>
                     <div class="col-sm-9">
...
<script>
   $(document).ready(function() {
    ...
    return false;
      ...
      $('#form_sp_materials').on('click', '.btn_add_new', function() {
         var params = {};
         params[csrf] = token;
