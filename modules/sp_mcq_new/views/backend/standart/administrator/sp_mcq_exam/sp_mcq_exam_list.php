                           ...
                           <div class="col-sm-3 padd-left-0  ">
                              <select class="form-control" name="chapter_id" id="chapter_id" data-placeholder="Select Chapter">
                                 ...
                                 <?php if(@$filter['chapter_id']){
                                    $chapters =$this->model_sp_mcq_exam->getChapterByCourse( @$filter['course_id']);
                           ...
                           <div class="col-sm-3 padd-left-0 ">
                              <select class="form-control " name="topic_id" id="topic_id" data-placeholder="Select Topic">
                                 ...
                                 <?php if(@$filter['topic_id']){
                                    $topics =$this->model_sp_mcq_exam->getTopicByChapter( @$filter['chapter_id']);
                           ...
                           <tbody>
                              ...
                              foreach ($results as $res) {
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $res->set_name;?></td>
                                    <td> <a  href="<?= admin_site_url('/sp_mcq_exam/start_practice/' . $res->id); ?>" class="btn btn-flat btn-success btn_add_new"><i class="fa fa-book"></i> <?= cclang('practice')?> </a></td>
                                 </tr>
                              <?php } ?>
                           </tbody>
                        </table>
      ...
      $('#teacher').change(function() {
         ...
         if (teacher !== '') {
            ...
            $.ajax({
               ...
               data:teacher,
               dataType: 'html',
               url: BASE_URL + '/administrator/sp_mcq_exam/getCourse/' + teacher,
