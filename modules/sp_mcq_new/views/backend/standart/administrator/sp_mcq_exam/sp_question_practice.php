...
<section class="content-header">
  <h1>
    Mcq Practice <small><?= cclang('detail', ['Mcq Practice']); ?> </small>
  </h1>
  <ol class="breadcrumb">
              ...
              <!-- <div class="row"> -->
                ...
                <div class="row quiz_box">
                  ...
                  <footer>
                    ...
                    <button class="explanation">Hint</button>
                  </footer>
                </div>
...
<script>
  const questions = <?php echo $questions; ?>; //selecting all required elements
