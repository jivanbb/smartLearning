...
<section class="content-header">
   <h1>
      MCQ Practise<small><?= cclang('list_all'); ?></small>
   </h1>
   <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">MCQ Practise</li>
   </ol>
</section>
<!-- Main content -->
         ...
         <div class="box box-warning">
            <div class="box-body ">
               <div class="box box-widget widget-user-2">
                  ...
                  <form name="form_sq_mcq_exam" id="form_sq_mcq_exam" action="<?= admin_base_url('/sp_mcq_practise/index'); ?>">
                     ...
                     <div class="row">
                        <div class="col-md-10">
                           ...
                           <div class="col-sm-2 padd-left-0 ">
                              <select class="form-control " name="course_id" id="course_id" data-placeholder="Course">
                                 ...
                                 <?php if(@$filter['course_id']){
                                    $courses =$this->model_sp_mcq_practise->getCourseByTeacher( @$filter['teacher']);
                           ...
                           <div class="col-sm-3 padd-left-0  ">
                              <select class="form-control" name="chapter_id" id="chapter_id" data-placeholder="Select Chapter">
                                 ...
                                 <?php if(@$filter['chapter_id']){
                                    $chapters =$this->model_sp_mcq_practise->getChapterByCourse( @$filter['course_id']);
                           ...
                           <div class="col-sm-3 padd-left-0 ">
                              <select class="form-control " name="topic_id" id="topic_id" data-placeholder="Select Topic">
                                 ...
                                 <?php if(@$filter['topic_id']){
                                    $topics =$this->model_sp_mcq_practise->getTopicByChapter( @$filter['topic_id']);
                           ...
                           <div class="col-sm-1 padd-left-0 ">
                              <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= admin_base_url('/sp_mcq_practise'); ?>" title="<?= cclang('reset_filter'); ?>">
                        ...
                        <table class="table table-bordered table-striped dataTable">
                           ...
                           <tbody>
                              ...
                              foreach ($results as $res) {
                                 $questions =get_no_of_question($res->id); 
                                 $sn++; ?>
                                 <tr>
                                    <td><?php echo $sn;?></td>
                                    ...
                                    <td> <a  href="<?= admin_site_url('/sp_mcq_practise/start_practice/' . $encrypted_id); ?>" class="btn btn-flat btn-success btn_add_new"><i class="fa fa-book"></i> <?= $res->set_name;?> </a></td>
                                 </tr>
                              <?php } ?>
                           </tbody>
                        </table>
