         ...
         <div class="box box-warning">
            <div class="box-body ">
               ...
               <?php if (check_role_exist_or_not(13, array("add"))) { ?>
                  <a class="btn btn-flat btn-success btn_add_new pull-right" id="btn_add_new" title="<?= cclang('add_new_button', [cclang('sq_mcq_question')]); ?>  (Ctrl+a)" href="<?= admin_site_url('/sp_mcq_setup/add'); ?>"><i class="fa fa-plus-square-o"></i> MCQ Setup</a>
                  <?php }?>
                  <form name="form_sq_mcq_question" id="form_sq_mcq_question" action="<?= admin_base_url('/sp_mcq_setup/index'); ?>">
                     <!-- /.widget-user -->
                     <div class="row">
                        <div class="col-md-8">
                           ...
                           <div class="col-sm-1 padd-left-2 ">
                              <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= admin_base_url('/sp_mcq_setup'); ?>" title="<?= cclang('reset_filter'); ?>">
                        ...
                        <table class="table table-bordered table-striped dataTable">
                           <thead>
                            ...
                            <input type="checkbox" class="flat-red toltip" id="check_all" name="check_all" title="check all">
                                 ...
                                 <th data-field="chapter_id" data-sort="1" data-primary-key="0"> <?= cclang('course') ?></th>
                                 <th data-field="time" data-sort="1" data-primary-key="0"> Time(In Min)</th>
                                 <th data-field="no_of_questions" data-sort="1" data-primary-key="0"> No  of Questions</th>
                                 <th data-field="question_mark" data-sort="1" data-primary-key="0">Question Mark</th>
                                 <th data-field="total_marks" data-sort="1" data-primary-key="0">Total Marks</th>
                                 <th data-field="pass_mark" data-sort="1" data-primary-key="0"> Pass Mark</th>
                                 <th>Action</th>
                              </tr>
                           </thead>
      ...
      $('.publish').click(function() {
			...
			Swal.fire({
				...
				if (result.isConfirmed) {
					$.ajax({
                    url: BASE_URL + 'administrator/sp_mcq_setup/publish_exam',
                    type: 'POST',
                    dataType: 'json',
                    data: {id:id},
                })
