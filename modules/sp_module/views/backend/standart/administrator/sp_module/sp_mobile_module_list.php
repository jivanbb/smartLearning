  ...
  <div class="top-bar-wrap">
    <div class="breadcrumb-part-wrap">
      <h4 class="breadcrumb-new">
        <a href="#" data-original-title="" title="">Home</a> <span>Menu</span>
      </h4>
    </div>
  </div>
    <!-- <h1>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="box box-warning">
          ...
          <div class="box-body ">
            ...
            <div class="menu-type-wrapper <?= $this->uri->segment(4) == 'side-menu' ? 'active' :''; ?>">
              <div data-href="<?= site_url('administrator/menu/index/'.url_title('side menu')); ?>"
                class="clickable btn-block menu-type btn-group "> <?= cclang('side_menu'); ?>
              </div>
            ...
            <?php foreach (db_get_all_data('menu_type', 'name!= "side menu"') as $row): ?>
              ...
              <span data-href="<?= site_url('administrator/menu/index/'.url_title($row->name)); ?>"
        ...
        <a href="<?= site_url('administrator/menu_type/add'); ?>"
          ...
          class="fa fa-plus-square-o"></i> <?= cclang('add_menu_type'); ?></a>
        </div>
        <!--/box body -->
      </div>
      <!--/box -->
    ...
    <div class="col-md-6">
      <div class="box box-warning">
        ...
        <div class="box-header with-border">
          ...
          <h3 class="box-title pull-left"><?= cclang('menu') ?>
          <?= ucwords(str_replace('-', ' ', $this->uri->segment(4))); ?></h3>
        </div>
        <div class="box-body ">
          <div class="message">
          ...
          <div style="margin: 15px 0px 15px 0px !important;">
            ...
            href="<?= site_url('administrator/oms_module/add'); ?>"><i
            class="fa fa-plus-square-o"></i> <?= cclang('add_new_button', cclang('menu')); ?></a>
            <!--  <?php }) ?> -->
            ...
            <div class="dd" id="nestable">
              <?php
              $menu = display_mobile_menu_module(0, 1, 'side-menu', true); 
              if (empty($menu)): ?>
...
<script>
  $(document).ready(function() {
    ...
    function updateOrderMenu(ignoreMessage) {
      ...
      $.ajax({
        url: BASE_URL + 'administrator/oms_module/save_ordering',
        type: 'POST',
        dataType: 'JSON',
        data: {
          'menu': menu,
    ...
    function setMenuActive(id, status) {
      ...
      $.ajax({
        url: BASE_URL + '/administrator/oms_module/set_status',
        type: 'POST',
        dataType: 'JSON',
        data: data,
      })
