      ...
      <div class="box box-warning">
        ...
        <div class="box-body ">
          ...
          <div style="margin: 15px 0px 15px 0px !important;">
            ...
            href="<?= site_url('administrator/sp_module/add'); ?>"><i
            ...
            <div class="dd" id="nestable">
              <?php
              $menu = display_custom_menu_module(0, 1, 'side-menu', true); 
              if (empty($menu)): ?>
...
<script>
  $(document).ready(function() {
    ...
    function updateOrderMenu(ignoreMessage) {
      ...
      $.ajax({
        url: BASE_URL + 'administrator/sp_module/save_ordering',
        type: 'POST',
        dataType: 'JSON',
        data: {
          'menu': menu,
    ...
    function setMenuActive(id, status) {
      ...
      $.ajax({
        url: BASE_URL + '/administrator/sp_module/set_status',
        type: 'POST',
        dataType: 'JSON',
        data: data,
      })
