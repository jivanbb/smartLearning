   ...
   <!-- <div class="col-md-12"> -->
      <div class="col-md-10">
         <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
               <li ><a href="<?php echo base_url(); ?>administrator/sp_sales_register">Sales Register</a></li>
               <li class="active"><a href="<?php echo base_url(); ?>administrator/sp_purchase_register">Purchase Register</a></li>
      ...
      <div class="col-md-2">
         <?php if (check_role_exist_or_not(29, array("add"))) { ?>
            <a href="<?php echo base_url(); ?>administrator/sp_purchase_register/add"  class="btn btn-flat btn-success btn_add_new pull-right" ><i class="fa fa-plus-square-o"></i> Purchase Register</a>
         <?php } ?>
      </div>
   <!-- </div> -->
         ...
         <div class="box box-warning">
            <div class="box-body ">
               <div class="box box-widget widget-user-2">
                  ...
                  <form name="form_sp_sales_register" id="form_sp_sales_register" action="<?= admin_base_url('/sp_purchase_register/index'); ?>">
                     <!-- /.widget-user -->
                     <div class="row">
                        <div class="col-md-8">
