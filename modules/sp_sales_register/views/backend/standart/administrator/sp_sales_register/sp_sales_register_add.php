...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class=""><a href="<?= admin_site_url('/sp_sales_register'); ?>"> Sales Register</a></li>
            ...
            <div class="box box-warning">
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open('', [
                            'name' => 'form_sp_sales_register_add',
                            'class' => 'form-horizontal form-step',
                            'id' => 'form_sp_sales_register_add',
                            'method' => 'POST'
                        ]); ?>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_save').click(function() {
            ...
            var form_sales_register = $('#form_sp_sales_register_add');
