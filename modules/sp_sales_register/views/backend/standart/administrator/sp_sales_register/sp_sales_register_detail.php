...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class=""><a href="<?= admin_site_url('/sp_sales_register'); ?>"> Sales Register Detail </a></li>
            ...
            <div class="box box-warning">
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-9" style="display: flex;">
                                        ...
                                        <a class="btn btn-flat btn-excel btn-success" title="<?= cclang('excel'); ?>" style="margin-left: 5px;"
                                            href="<?= site_url('administrator/sp_sales_register/sales_register_excel/?' . http_build_query($this->input->get())); ?>"><i
                        ...
                        <hr>
                        <?= form_open('', [
                            'name' => 'form_sp_sales_register_detail',
                            'class' => 'form-horizontal form-step',
                            'id' => 'form_sp_sales_register_detail',
                            'method' => 'POST'
                        ]); ?>
                        <!-- <div class="row"> -->
                        <!-- <div class="col-md-12"> -->
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped dataTable" style=" min-width: 2500px; max-width: max-content;">
                                <thead>
                                    <tr class="">
                                        <th style="width:300px;">मिति</th>
                                        <th style="width:280px; ">बीजक नम्बर</th>
                                        <th style="width:300px;">खरिदकर्ताको स्थायी लेखा नम्बर</th>
                                        <th style="width:350px;">खरिदकर्ताको नाम</th>
                                        <th style="width:300px;">वस्तु वा सेवाको नाम</th>
                                        <th style="width:300px;">वस्तु वा सेवाको परिमाण</th>
                                        <th style="width:300px;">वस्तु वा सेवाको एकाई</th>
                                        <th style="width:300px;">जम्मा बिक्री / निकासी (रु)</th>
                                        <th style="width:500px;">स्थानीय कर छुटको बिक्री मूल्य (रु)</th>
                                        <th style="width:400px;">करयोग्य बिक्री मूल्य (रु)</th>
                                        <th style="width:300px;">करयोग्य बिक्री कर (रु)</th>
                                        <th style="width:300px;">निकासी गरेको वस्तु वा सेवाको मूल्य</th>
                                        <th style="width:300px;">निकासी गरेको देश</th>
                                        <th style="width:300px;">निकासी प्रज्ञापनपत्र मिति </th>
                                        <th style="width:300px;">निकासी प्रज्ञापनपत्र नम्बर</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
...
<div id="uploadcsv" class="modal fade bd-example-modal-sm" role="dialog">
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <?= form_open(base_url('administrator/sp_sales_register/import'), [
                ...
                <div class="row ">
                    <div class="col-md-12">
                        <div class="form-wrap">
                            ...
                            <input type="hidden" name="sales_register_id" value="<?php echo $register_id;?>">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_save').click(function() {
            ...
            var form_sp_sales_register_detail = $('#form_sp_sales_register_detail');
            var data_post = form_sp_sales_register_detail.serializeArray();
            $('.loading').show();

            $.ajax({
                    url: ADMIN_BASE_URL + '/sp_sales_register/detail_save',
                    type: 'POST',
                    dataType: 'json',
                    data: data_post,
                })
