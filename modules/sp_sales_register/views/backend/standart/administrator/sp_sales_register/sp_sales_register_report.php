...
<div class="row-fluid">
   <!-- <div class="col-md-12"> -->
   <div class="col-md-12+76
      ">
      <div class="nav-tabs-custom">
         <ul class="nav nav-tabs">
            <li class="active"><a href="<?php echo base_url(); ?>administrator/sp_sales_register/report">Sales Register</a></li>
            <li><a href="<?php echo base_url(); ?>administrator/sp_purchase_register/report">Purchase Register</a></li>
         ...
         <div class="box box-warning">
            <div class="box-body ">
               <div class="box box-widget widget-user-2">
                  ...
                  <form name="form_sp_sales_register" id="form_sp_sales_register" action="<?= admin_base_url('/sp_sales_register/report'); ?>">
                     <!-- /.widget-user -->
                     <div class="row">
                        <div class="col-md-12">
                           ...
                           <div class="col-sm-1 padd-left-2 ">
                              <a class="btn btn-default btn-flat" name="reset" id="reset" value="Apply" href="<?= admin_base_url('/sp_sales_register/report'); ?>" title="<?= cclang('reset_filter'); ?>">
                              ...
                              <?php if ($count > 0) {
                                 foreach ($sales_list as $sales) { ?>
                                    <tr>
                                       ...
                                       <td> <a href="<?= admin_site_url('/sp_sales_register/view/' . $sales->id); ?>" data-id="<?= $sales->id ?>" class="label-default btn-act-edit"><i class="fa fa-eye "></i> </a></td>
                                    </tr>
