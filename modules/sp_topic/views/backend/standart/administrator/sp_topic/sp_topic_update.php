                ...
                <div class="box-body ">
                    <div class="box box-widget widget-user-2">
                        <div class="widget-user-header ">
                            ...
                            <h3 class="widget-user-username">Topic</h3>
                            <h5 class="widget-user-desc">Edit Topic</h5>
                            <hr>
                        </div>
                        <?= form_open(admin_base_url('/sp_topic/edit_save/' . $this->uri->segment(4)), [
                            'name' => 'form_sp_topic_edit',
                            'class' => 'form-horizontal form-step',
                            'id' => 'form_sp_topic_edit',
                            'method' => 'POST'
                        ]); ?>
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="course_id" id="course_id" data-placeholder="Select Course">
                                    ...
                                    <?php foreach (db_get_all_data('sp_course', $conditions) as $row): ?>
                                        <option <?= $row->id == $sp_topic->course_id ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-sm-8">
                                <select class="form-control chosen chosen-select-deselect" name="chapter_id" id="chapter_id" data-placeholder="Select Chapter">
                                    ...
                                    <?php foreach (db_get_all_data('sp_chapter', $conditions) as $row): ?>
                                        <option <?= $row->id == $sp_topic->chapter_id ? 'selected' : ''; ?> value="<?= $row->id ?>"><?= $row->name; ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <small class="info help-block">
                                </small>
                        ...
                        <div class="form-group group-topic_no  ">
                            <label for="topic_no" class="col-sm-2 control-label">Topic No <i class="required">*</i>
                            </label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="topic_no" id="topic_no" placeholder="" value="<?= set_value('topic_no', $sp_topic->topic_no); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-group group-name  ">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="name" id="name" placeholder="" value="<?= set_value('name', $sp_topic->name); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.btn_save').click(function() {
            ...
            var form_sp_topic = $('#form_sp_topic_edit');
            ...
            $.ajax({
                ...
                .done(function(res) {
                    ...
                    if (res.success) {
                        var id = $('#sp_topic_image_galery').find('li').attr('qq-file-id');
                        if (save_type == 'back') {
