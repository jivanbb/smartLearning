      ...
      <div class="col-md-12">
         <div class="box box-warning">
            <div class="box-body ">
               ...
               <a class="btn btn-flat pull-right btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', cclang('user')); ?> (Ctrl+a)" href="<?= admin_site_url('/user/add'); ?>"><i class="fa fa-plus-square-o"></i> <?= cclang('add_new_button', cclang('user')); ?></a>
               <?php }?>
                           ...
                           <tbody id="tbody_user">
                              <?php foreach ($users as $user) : ?>
                                 <tr>
                                    ...
                                    <td width="200">
                                          <a href="<?= admin_site_url('/user/edit/' . $user->id); ?>" class="label-default"><i class="fa fa-edit "></i> </a>
                                          <a href="javascript:void(0);" data-href="<?= admin_site_url('/user/delete/' . $user->id); ?>" class="label-default remove-data"><i class="fa fa-close"></i> </a>
                                    </td>
                                 </tr>
                              <?php endforeach; ?>
