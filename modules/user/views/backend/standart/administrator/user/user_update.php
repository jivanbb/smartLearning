            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="form-group ">
                            <label for="full_name" class="col-sm-2 control-label"><?= cclang('phone'); ?> <i class="required">*</i></label>

                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="phone_no" id="phone_no" placeholder="Phone" value="<?= set_value('phone_no', $user->phone_no); ?>">
                                <small class="info help-block">The phone of user.</small>
                            </div>
                            <label for="content" class="col-sm-2 control-label"><?= cclang('role'); ?> <i class="required">*</i></label>

                            <div class="col-sm-4">
                                <select class="form-control chosen-select" name="group[]" id="group" multiple placeholder="Select role">
